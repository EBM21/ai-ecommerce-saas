                ...
                {PRE_BUILT_THEMES.map((theme) => (
                    <div key={theme.id} className="group relative rounded-3xl overflow-hidden border border-border bg-card shadow-sm hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="relative aspect-[4/3] w-full overflow-hidden bg-secondary">
                            ...
                            {/* Hover Actions */}
                            <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-0 md:translate-y-8 opacity-100 md:opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-4">
                                <button
